...
class ContainerPage extends GetView<ContainerController> {
  ...
  ContainerPage({Key? key, required this.user, currentWidget, appBarTitle, this.drawerSelection = DrawerSelection.Home})
                            ...
                            children: [
                              ...
                              ListTileTheme(
                                ...
                                child: ListTile(
                                    ...
                                    title: Text(MyAppState.currentUser == null ? 'Login'.tr : 'Log Out'.tr),
                                    onTap: () async {
                                      if (MyAppState.currentUser == null) {
