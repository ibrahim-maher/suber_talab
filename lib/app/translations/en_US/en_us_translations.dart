...
final Map<String, String> enUs = {
    ...
    "Order food from restaurants around you and track food in real-time": "Order food from restaurants around you and track food in real-time",
    "Log In": "Log In",
    "Sign Up": "Sign Up",
    ...
    "Your cart is empty, Let's order food!": "Your cart is empty, Let's order food!",
    "Total : ": "Total : ",
    ...
    "No vendors found for the selected cuisine": "No restaurant found for the selected cuisine",
    "Start recording": "Start recording",
    "Settings": "Settings",
    "No Messages Yet": "No Messages Yet",
    "Send a new message and it will show up here": "Send a new message and it will show up here",
    ...
    "locationSearchingRestaurants": "Set your location to started searching for restaurants in your area",
    "Select": "Select",
    "Change": "Change",
    "Find your restaurant": "Find your restaurant",
    "New Arrivals": "New Arrivals",
    "Start by adding vendors to firebase.": "Start by adding vendors to firebase.",
    ...
    "DONE": "DONE",
    "selectGPSLocation": "Please select current address using GPS location. Move pin to exact location",
    ...
    "Hello": "Hello",
    "Find your": "Find your",
    "wantChangeDeliveryOption": "Do you really want to change the delivery option? \n",
    ...
    "No Deals": "No Deals",
    "Start by adding best deals to firebase.": "Start by adding best deals to firebase.",
    "Start by adding categories to firebase.": "Start by adding categories to firebase.",
    ...
    "COPY CODE": "COPY CODE",
    "accountDisabledContactAdmin": "Your account has been disabled, Please contact to admin.",
    ...
    "Find perfect restaurant nearby or  place order at your favorite restaurant in few clicks.": "Find perfect restaurant nearby or  place order at your favorite restaurant in few clicks.",
    "A diverse list of different dining restaurants throughout the territory and around your area carefully selected": "A diverse list of different dining restaurants throughout the territory and around your area carefully selected",
    "Get your favorite food fastest delivered at your doorstep": "Get your favorite food fastest delivered at your doorstep",
    ...
    "LocationPermanentlyDenied": "Location permissions are permanently denied, we cannot request permissions.",
